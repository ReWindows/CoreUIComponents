...
public:
    ...
    // Symbol: ?Invoke@ViewManager__ShowStandardSystemOverlaysEventHandler@Server@Navigation@CoreUI@Microsoft@@QEAAXUViewInstanceId@345@@Z
    void Invoke(WindissectOpaque);
};
} // namespace Microsoft::CoreUI::Navigation::Server
