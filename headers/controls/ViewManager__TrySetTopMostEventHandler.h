...
public:
    ...
    // Symbol: ?Invoke@ViewManager__TrySetTopMostEventHandler@Server@Navigation@CoreUI@Microsoft@@QEAAXUViewInstanceId@345@_N@Z
    void Invoke(WindissectOpaque, bool);
};
} // namespace Microsoft::CoreUI::Navigation::Server
