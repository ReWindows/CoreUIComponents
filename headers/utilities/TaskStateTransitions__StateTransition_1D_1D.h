...
public:
    ...
    // Symbol: ?InitializeItems@TaskStateTransitions__StateTransition_1D_1D@Server@Navigation@CoreUI@Microsoft@@QEAAPEAV12345@HZZ
    WindissectOpaque * InitializeItems(int, ...);
};
} // namespace Microsoft::CoreUI::Navigation::Server
