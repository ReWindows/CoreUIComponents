//! Windissect-generated Rust FFI bindings for CoreUIComponents.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "B405E11DB9F2D4C56129F644C02687C7";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 222445461;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 21] = [67, 111, 114, 101, 85, 73, 67, 111, 109, 112, 111, 110, 101, 110, 116, 115, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 222445461 { return 0; }
